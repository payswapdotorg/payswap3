...
**Companions:** `spec/deployment/environments.md` (environment contract), `spec/deployment/configuration.md` (configuration and secret boundary contract), `spec/deployment/packaging.md` (runtime packaging contract), `spec/deployment/ci-cd.md` (CI/CD and promotion contract, DEP-006), `deploy/contracts/components.json` (machine-readable component registry), `scripts/validate_deployment.py` (static/configuration verification gate)
